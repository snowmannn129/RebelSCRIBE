...
# -*- coding: utf-8 -*-
"""
Script to run the RebelCAD integration for RebelSCRIBE.

This script extracts documentation from RebelCAD source code and generates
...
def main():
    """Main function."""
    # Parse arguments
    parser = argparse.ArgumentParser(description="Run RebelCAD integration for RebelSCRIBE")
    ...
    try:
        ...
        if not output_dir:
            output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "docs", "rebelcad")
        
        print(f"RebelSUITE root directory: {rebelsuite_root}")
        print(f"Output directory: {output_dir}")
        
        # Create integration
        integration = RebelCADIntegration(rebelsuite_root)
