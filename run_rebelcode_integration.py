...
# -*- coding: utf-8 -*-
"""
Script to run the RebelCODE integration for RebelSCRIBE.

This script extracts documentation from RebelCODE source code and generates
...
def main():
    """Main function."""
    # Parse arguments
    parser = argparse.ArgumentParser(description="Run RebelCODE integration for RebelSCRIBE")
    ...
    try:
        ...
        if not output_dir:
            output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "docs", "rebelcode")
        
        print(f"RebelSUITE root directory: {rebelsuite_root}")
        print(f"Output directory: {output_dir}")
        
        # Create integration
        integration = RebelCODEIntegration(rebelsuite_root)
