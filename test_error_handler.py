...
# -*- coding: utf-8 -*-
"""
RebelSCRIBE - Enhanced Error Handler Test Script
...
# Set up logging
setup_logging(
    log_file="error_handler_test.log",
    console_output=True,
    file_output=True
)
...
class ErrorHandlerTestWindow(QMainWindow):
    """
    Test window for showcasing the enhanced error handler.
    """
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Enhanced Error Handler Test")
        ...
        # Add title
        title_label = QLabel("Enhanced Error Handler Test")
        ...
        description_label = QLabel(
            "This script demonstrates the enhanced error handler features.\n"
        ...
        self.severity_combo.setCurrentIndex(0)  # Default to INFO
        ...
        logger.info("Error Handler Test window initialized")
    ...
    def _register_components(self):
        ...
        self.error_handler.register_component(
            component_name="ErrorHandlerTest",
            metadata={"description": "Error Handler Test Application"}
        )
        
        # Register sub-components
        self.error_handler.register_component(
            component_name="ErrorHandlerTest.UI",
            parent_component="ErrorHandlerTest",
            metadata={"description": "UI Components"}
        )
        
        self.error_handler.register_component(
            component_name="ErrorHandlerTest.Logic",
            parent_component="ErrorHandlerTest",
            metadata={"description": "Business Logic"}
        )
        
        self.error_handler.register_component(
            component_name="ErrorHandlerTest.Data",
            parent_component="ErrorHandlerTest",
    ...
    def _on_exception(self):
        ...
        try:
            ...
            error_id = self.error_handler.handle_exception(
                ...
                severity=self._get_selected_severity(),
                component="ErrorHandlerTest.Logic",
                parent=self
            )
    ...
    def _on_component_error(self):
        ...
        components = [
            "ErrorHandlerTest.UI",
            "ErrorHandlerTest.Logic",
            "ErrorHandlerTest.Data"
        ]
...
def main():
    ...
    logger.info("Starting Enhanced Error Handler Test")
